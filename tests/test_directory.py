import _6810110042.directory as directory
...
class DirectoryTest(unittest.TestCase):
    ...
    @mock.patch("_6810110042.directory.check_directory", return_value=True)
    ...
    @mock.patch("pathlib.Path")
    @mock.patch("_6810110042.directory.check_directory", return_value=False)
